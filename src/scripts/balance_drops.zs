...
Dropt.list("playa_dust_small")
    ...
    .add(Dropt.rule()
        ...
        .addDrop(Dropt.drop()
            .selector(Dropt.weight(5))
            .items([<weather2:sand_layer_placeable>, <minecraft:clay_ball>])
        )
        .addDrop(Dropt.drop()
            .selector(Dropt.weight(2))
...
Dropt.list("playa_dust_large")
    ...
    .add(Dropt.rule()
        ...
        .addDrop(Dropt.drop()
            ...
            .items([<weather2:sand_layer_placeable>, <minecraft:clay_ball> * 2])
        )
        .addDrop(Dropt.drop()
            .selector(Dropt.weight(5))
            .items([<weather2:sand_layer_placeable>, <minecraft:iron_ingot>])
...
Dropt.list("sand_tho")
    ...
    .add(Dropt.rule()
        ...
        .addDrop(Dropt.drop()
            .selector(Dropt.weight(5))
            .items([<weather2:sand_layer_placeable>, <minecraft:clay_ball> * 3])
        )
        .addDrop(Dropt.drop()
